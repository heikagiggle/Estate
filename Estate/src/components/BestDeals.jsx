...
const BestDeals = () => {
  return (
    <div>
      <div className="w-11/12 md:w-1/2 xl:w-1/3 text-center m-auto py-10">
        <h1 className="text-4xl font-bold">
          Best Deals you will now want to miss
        </h1>
      ...
      <div className="deals w-full grid lg:grid-flow-col flow grid-rows-2 gap-8">
        <div className="deals relative col-span-2 row-span-2">
          <img
            src={house1}
            alt=""
        ...
        <div className="deals relative col-span-1 row-span-2">
          <img
            src={house2}
            alt=""
            className="w-full h-full rounded-xl object-cover"
        ...
        <div className="deals relative col-span-1 row-span-1">
          <img
            src={house3}
            alt=""
            className="w-full h-full rounded-xl object-cover"
        ...
        <div className="deals relative col-span-2 row-span-1">
          <img
            src={house5}
            alt=""
            className="w-full h-full rounded-xl object-cover"
